...
function HomePage() {
  return (
    <div className="homePage">
      <h1 className="title">Rate and Reaction Conditions Input</h1>
      <form className="input-form">
        ...
        <label className="form-label">
          ...
          <input type="number" placeholder="MTT (K)" className="form-input" />
        </label>
        <label className="form-label">
      ...
      <h1 className="title">Reactants and Products Input</h1>
      <form className="input-form">
        <label className="form-label">
          Select Reactant 1:
